...
import { ITEM_ACTIONS, findItemAction, type ItemAction } from "../src/item/item.actions-map";
...
import { resolveItemAction } from "../src/item/item.actions-map";
import type { EquipmentEntry } from "../src/pc/pc.types";
