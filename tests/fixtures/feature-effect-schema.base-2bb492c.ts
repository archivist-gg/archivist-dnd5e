// GENERATED by Task 0 of docs/superpowers/plans/2026-08-28-r4-g1a-class-refusals.md (plugin repo):
// git show 2bb492c:src/schemas/feature-effect-schema.ts  ·  the PRE-widening union, frozen for G15.
// Do not edit. Its only import is zod; it must contain no "immunity" arm.
import { z } from "zod";
